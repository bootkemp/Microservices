...
public interface CarApi {
    ...
    ResponseEntity<Void> addCar(@ApiParam(value = "Car object that needs to be added to the showroom" ,required=true )  @Valid @RequestBody Car body);
    ...
    ResponseEntity<Void> deleteCar(@ApiParam(value = "Car Number to delete",required=true) @PathVariable("carNumber") Long carNumber);
